...
$progsecret = Encrypt(json_encode(array("status" => "failed", "info" => "Program secret doesn't exist")));
$usertaken = Encrypt(json_encode(array("status" => "failed", "info" => "Username doesn't exist!")));
$invalidtoken = Encrypt(json_encode(array("status" => "failed", "info" => "Invalid token.")));
$finaleerror = Encrypt(json_encode(array("status" => "failed", "info" => "Unable to update expired time.")));
$tokenerror = Encrypt(json_encode(array("status" => "failed", "info" => "Couldn't update token.")));
$banned = Encrypt(json_encode(array("status" => "failed", "info" => "Your account is banned!")));
$incorrecthwid = Encrypt(json_encode(array("status" => "failed", "info" => "Incorrect hwid!")));
$bruh = Encrypt(json_encode(array("status" => "failed", "info" => "Invalid username/password!")));
